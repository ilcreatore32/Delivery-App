...
-- Volcando estructura para tabla delivery.areaoperaciones
DROP TABLE IF EXISTS `areaoperaciones`;
CREATE TABLE IF NOT EXISTS `areaoperaciones` (
  ...
  PRIMARY KEY (`AO_EFId`,`AO_MunicipioId`,`AO_ParroquiaId`,`AO_STId`),
  KEY `fk_AreaOperaciones_EntidadesFederales1_idx` (`AO_EFId`),
  KEY `fk_AreaOperaciones_Municipios1_idx` (`AO_MunicipioId`),
  KEY `fk_AreaOperaciones_Parroquias1_idx` (`AO_ParroquiaId`),
  KEY `fk_AreaOperaciones_ServicioTransporte1_idx` (`AO_STId`),
  CONSTRAINT `fk_AreaOperaciones_EntidadesFederales1` FOREIGN KEY (`AO_EFId`) REFERENCES `entidadesfederales` (`EF_Id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_AreaOperaciones_Municipios1` FOREIGN KEY (`AO_MunicipioId`) REFERENCES `municipios` (`Municipio_Id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_AreaOperaciones_Parroquias1` FOREIGN KEY (`AO_ParroquiaId`) REFERENCES `parroquias` (`Parroquia_Id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_AreaOperaciones_ServicioTransporte1` FOREIGN KEY (`AO_STId`) REFERENCES `serviciotransporte` (`ST_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla delivery.areaoperaciones: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `areaoperaciones` DISABLE KEYS */;
INSERT INTO `areaoperaciones` (`AO_EFId`, `AO_MunicipioId`, `AO_ParroquiaId`, `AO_STId`) VALUES
	(24, 0, 0, 4),
	(24, 0, 0, 7),
	(24, 462, 1137, 4),
	(24, 462, 1137, 7);
/*!40000 ALTER TABLE `areaoperaciones` ENABLE KEYS */;

-- Volcando estructura para tabla delivery.contacto
DROP TABLE IF EXISTS `contacto`;
CREATE TABLE IF NOT EXISTS `contacto` (
  `Contacto_Info` varchar(100) NOT NULL,
  `Contacto_Tipo` char(1) NOT NULL DEFAULT '',
  `Contacto_Status` char(1) NOT NULL DEFAULT 'A',
  `Contacto_PersonaId` int(9) unsigned NOT NULL,
  PRIMARY KEY (`Contacto_PersonaId`,`Contacto_Info`),
  CONSTRAINT `FK_Persona_Id` FOREIGN KEY (`Contacto_PersonaId`) REFERENCES `personas` (`Persona_Id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla delivery.contacto: ~6 rows (aproximadamente)
/*!40000 ALTER TABLE `contacto` DISABLE KEYS */;
INSERT INTO `contacto` (`Contacto_Info`, `Contacto_Tipo`, `Contacto_Status`, `Contacto_PersonaId`) VALUES
	('4126587931', 'T', 'A', 13969711),
	('4167953268', 'T', 'A', 13969711),
	('4242843235', 'T', 'A', 20000000),
	('email@email.com', 'C', 'A', 20000000),
	('4242843235', 'T', 'A', 28044244),
	('jesusemail@email.net', 'C', 'A', 28044244);
/*!40000 ALTER TABLE `contacto` ENABLE KEYS */;

-- Volcando estructura para tabla delivery.direcciondetalle
DROP TABLE IF EXISTS `direcciondetalle`;
CREATE TABLE IF NOT EXISTS `direcciondetalle` (
  ...
  PRIMARY KEY (`DD_Id`,`DD_SEId`),
  KEY `fk_DireccionDetalle_SolicitudesEnvioProductos1_idx` (`DD_SEId`),
  CONSTRAINT `fk_DireccionDetalle_SolicitudesEnvioProductos1` FOREIGN KEY (`DD_SEId`) REFERENCES `solicitudesenvio` (`SE_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla delivery.direcciondetalle: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `direcciondetalle` DISABLE KEYS */;
/*!40000 ALTER TABLE `direcciondetalle` ENABLE KEYS */;

-- Volcando estructura para tabla delivery.entidadesfederales
DROP TABLE IF EXISTS `entidadesfederales`;
CREATE TABLE IF NOT EXISTS `entidadesfederales` (
  `EF_Id` tinyint(2) unsigned NOT NULL,
  `EF_Nombre` varchar(45) NOT NULL,
  PRIMARY KEY (`EF_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla delivery.entidadesfederales: ~26 rows (aproximadamente)
/*!40000 ALTER TABLE `entidadesfederales` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `entidadesfederales` ENABLE KEYS */;

-- Volcando estructura para tabla delivery.mediotransporte
...
-- Volcando datos para la tabla delivery.mediotransporte: ~2 rows (aproximadamente)
...
-- Volcando estructura para tabla delivery.municipios
DROP TABLE IF EXISTS `municipios`;
CREATE TABLE IF NOT EXISTS `municipios` (
  `Municipio_Id` smallint(3) unsigned NOT NULL AUTO_INCREMENT,
  `Municipio_Nombre` varchar(45) NOT NULL,
  `Municipio_EFId` tinyint(2) unsigned NOT NULL,
  PRIMARY KEY (`Municipio_Id`),
  KEY `FK_Municipio_EntidadF_idx` (`Municipio_EFId`),
  CONSTRAINT `FK_Municipio_EntidadF` FOREIGN KEY (`Municipio_EFId`) REFERENCES `entidadesfederales` (`EF_Id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=18446744073709551615 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla delivery.municipios: ~337 rows (aproximadamente)
...
-- Volcando estructura para tabla delivery.pago_suscripcion
DROP TABLE IF EXISTS `pago_suscripcion`;
CREATE TABLE IF NOT EXISTS `pago_suscripcion` (
  `PS_Id` bigint(10) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`PS_Id`),
  KEY `fk_Pago_Suscripcion_Suscripcion1_idx` (`PS_SuscripcionId`),
  CONSTRAINT `fk_Pago_Suscripcion_Suscripcion1` FOREIGN KEY (`PS_SuscripcionId`) REFERENCES `suscripcion` (`Suscripcion_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla delivery.pago_suscripcion: ~2 rows (aproximadamente)
...
-- Volcando estructura para tabla delivery.parroquias
...
CREATE TABLE IF NOT EXISTS `parroquias` (
  ...
  KEY `FK_Parroquia_Municipio_idx` (`Parroquia_MunicipioId`),
  CONSTRAINT `FK_Parroquia_Municipio` FOREIGN KEY (`Parroquia_MunicipioId`) REFERENCES `municipios` (`Municipio_Id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla delivery.parroquias: ~1.140 rows (aproximadamente)
...
-- Volcando estructura para tabla delivery.personas
DROP TABLE IF EXISTS `personas`;
CREATE TABLE IF NOT EXISTS `personas` (
  `Persona_Id` int(9) unsigned NOT NULL,
  `Persona_TipoId` char(1) NOT NULL DEFAULT 'V',
  ...
  UNIQUE KEY `Cedula_UNIQUE` (`Persona_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla delivery.personas: ~6 rows (aproximadamente)
...
INSERT INTO `personas` (`Persona_Id`, `Persona_TipoId`, `Persona_Nombre`, `Persona_Apellido`, `Persona_Status`, `Persona_Archivo`) VALUES
	...
	(28044244, 'V', 'Jesus', 'Rivas', 'N', NULL),
	(28777277, 'V', 'Ubaldo', 'PEREZ', 'N', NULL);
/*!40000 ALTER TABLE `personas` ENABLE KEYS */;

-- Volcando estructura para tabla delivery.productos
DROP TABLE IF EXISTS `productos`;
CREATE TABLE IF NOT EXISTS `productos` (
  `Producto_Id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `idProductos_UNIQUE` (`Producto_Id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla delivery.productos: ~3 rows (aproximadamente)
...
INSERT INTO `productos` (`Producto_Id`, `Producto_Nombre`, `Producto_Tipo`, `Producto_Tamano`, `Producto_Peso`, `Producto_Precio`) VALUES
	...
	(4, 'Harina de Trigo', 'Harinas', 10.00, 1.00, 50.00);
/*!40000 ALTER TABLE `productos` ENABLE KEYS */;

-- Volcando estructura para tabla delivery.producto_has_se
DROP TABLE IF EXISTS `producto_has_se`;
CREATE TABLE IF NOT EXISTS `producto_has_se` (
  ...
  PRIMARY KEY (`ProductoSE_ProductoId`,`ProductoSE_SEId`),
  KEY `fk_Productos_has_SolicitudesEnvio_SolicitudesEnvio1_idx` (`ProductoSE_SEId`),
  KEY `fk_Productos_has_SolicitudesEnvio_Productos1_idx` (`ProductoSE_ProductoId`),
  CONSTRAINT `fk_Productos_has_SolicitudesEnvio_Productos1` FOREIGN KEY (`ProductoSE_ProductoId`) REFERENCES `productos` (`Producto_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Productos_has_SolicitudesEnvio_SolicitudesEnvio1` FOREIGN KEY (`ProductoSE_SEId`) REFERENCES `solicitudesenvio` (`SE_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla delivery.producto_has_se: ~6 rows (aproximadamente)
/*!40000 ALTER TABLE `producto_has_se` DISABLE KEYS */;
INSERT INTO `producto_has_se` (`ProductoSE_ProductoId`, `ProductoSE_SEId`, `ProductoSE_Cantidad`) VALUES
	...
	(2, 11, 5),
	(2, 14, 1);
/*!40000 ALTER TABLE `producto_has_se` ENABLE KEYS */;

-- Volcando estructura para tabla delivery.serviciotransporte
DROP TABLE IF EXISTS `serviciotransporte`;
CREATE TABLE IF NOT EXISTS `serviciotransporte` (
  ...
  KEY `fk_ServicioTransporte_MedioTransporte1_idx` (`ST_MTId`),
  KEY `fk_ServicioTransporte_Personas1_idx` (`ST_PersonaId`),
  KEY `fk_ServicioTransporte_Vehiculos1_idx` (`ST_VehiculoId`),
  CONSTRAINT `fk_ServicioTransporte_MedioTransporte1` FOREIGN KEY (`ST_MTId`) REFERENCES `mediotransporte` (`MT_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_ServicioTransporte_Personas1` FOREIGN KEY (`ST_PersonaId`) REFERENCES `personas` (`Persona_Id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_ServicioTransporte_Vehiculos1` FOREIGN KEY (`ST_VehiculoId`) REFERENCES `vehiculos` (`Vehiculo_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla delivery.serviciotransporte: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `serviciotransporte` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `serviciotransporte` ENABLE KEYS */;

-- Volcando estructura para tabla delivery.se_has_st
DROP TABLE IF EXISTS `se_has_st`;
CREATE TABLE IF NOT EXISTS `se_has_st` (
  `SEST_SEId` int(10) unsigned NOT NULL,
  `SEST_STId` int(10) unsigned NOT NULL,
  `SEST_Status` char(1) NOT NULL DEFAULT 'A',
  PRIMARY KEY (`SEST_SEId`,`SEST_STId`),
  KEY `fk_SolicitudesEnvioProductos_has_ServicioTransporte_Servici_idx` (`SEST_STId`),
  KEY `fk_SolicitudesEnvioProductos_has_ServicioTransporte_Solicit_idx` (`SEST_SEId`),
  CONSTRAINT `fk_SolicitudesEnvioProductos_has_ServicioTransporte_ServicioT1` FOREIGN KEY (`SEST_STId`) REFERENCES `serviciotransporte` (`ST_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_SolicitudesEnvioProductos_has_ServicioTransporte_Solicitud1` FOREIGN KEY (`SEST_SEId`) REFERENCES `solicitudesenvio` (`SE_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla delivery.se_has_st: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `se_has_st` DISABLE KEYS */;
INSERT INTO `se_has_st` (`SEST_SEId`, `SEST_STId`, `SEST_Status`) VALUES
	(8, 4, 'A'),
	(11, 4, '2');
/*!40000 ALTER TABLE `se_has_st` ENABLE KEYS */;

-- Volcando estructura para tabla delivery.solicitudesenvio
DROP TABLE IF EXISTS `solicitudesenvio`;
CREATE TABLE IF NOT EXISTS `solicitudesenvio` (
  ...
  PRIMARY KEY (`SE_Id`),
  UNIQUE KEY `idSolicitudesEnvioProductos_UNIQUE` (`SE_Id`),
  KEY `fk_SolicitudesEnvioProductos_Personas1_idx` (`SE_PersonaId`),
  KEY `fk_SolicitudesEnvio_Parroquias1_idx` (`SE_ParroquiaId`),
  CONSTRAINT `fk_SolicitudesEnvioProductos_Personas1` FOREIGN KEY (`SE_PersonaId`) REFERENCES `personas` (`Persona_Id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_SolicitudesEnvio_Parroquias1` FOREIGN KEY (`SE_ParroquiaId`) REFERENCES `parroquias` (`Parroquia_Id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla delivery.solicitudesenvio: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `solicitudesenvio` DISABLE KEYS */;
INSERT INTO `solicitudesenvio` (`SE_Id`, `SE_Fecha`, `SE_Status`, `SE_ValorTotal`, `SE_PesoTotal`, `SE_PersonaId`, `SE_ParroquiaId`) VALUES
	(8, '1999-09-25', '1', 33.00, 7.50, 13969711, 1137),
	(11, '2012-09-25', '1', 55.00, 12.50, 25449375, 1137),
	(14, '2020-05-01', 'D', 20.00, 20.00, 20000000, 1137);
/*!40000 ALTER TABLE `solicitudesenvio` ENABLE KEYS */;

-- Volcando estructura para tabla delivery.suscripcion
DROP TABLE IF EXISTS `suscripcion`;
CREATE TABLE IF NOT EXISTS `suscripcion` (
  `Suscripcion_Id` bigint(10) NOT NULL AUTO_INCREMENT,
  ...
  KEY `fk_Suscripcion_Personas1_idx` (`Suscripcion_PersonaId`),
  KEY `fk_Suscripcion_Tipo_Suscripcion1_idx` (`Suscripcion_TSId`),
  CONSTRAINT `fk_Suscripcion_Personas1` FOREIGN KEY (`Suscripcion_PersonaId`) REFERENCES `personas` (`Persona_Id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_Suscripcion_Tipo_Suscripcion1` FOREIGN KEY (`Suscripcion_TSId`) REFERENCES `tipo_suscripcion` (`TS_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla delivery.suscripcion: ~2 rows (aproximadamente)
...
INSERT INTO `suscripcion` (`Suscripcion_Id`, `Suscripcion_Status`, `Suscripcion_Monto`, `Suscripcion_FechaI`, `Suscripcion_FechaV`, `Suscripcion_PersonaId`, `Suscripcion_TSId`) VALUES
	(7, 'V', 60.00, '2021-10-19', '2021-11-19', 28044244, 2),
	(17, 'P', 50.00, '2021-12-06', '2021-12-07', 28777277, 2);
/*!40000 ALTER TABLE `suscripcion` ENABLE KEYS */;

-- Volcando estructura para tabla delivery.tipo_suscripcion
...
CREATE TABLE IF NOT EXISTS `tipo_suscripcion` (
  ...
  PRIMARY KEY (`TS_Id`),
  UNIQUE KEY `idPagoFianza_UNIQUE` (`TS_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla delivery.tipo_suscripcion: ~2 rows (aproximadamente)
...
-- Volcando estructura para tabla delivery.usuarios
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  UNIQUE KEY `idUsuarios_UNIQUE` (`Usuario_Id`),
  UNIQUE KEY `Usuario_Correo_UNIQUE` (`Usuario_Correo`),
  CONSTRAINT `FK_Usuario_Persona` FOREIGN KEY (`Usuario_Id`) REFERENCES `personas` (`Persona_Id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla delivery.usuarios: ~2 rows (aproximadamente)
...
-- Volcando estructura para tabla delivery.valoracion
DROP TABLE IF EXISTS `valoracion`;
CREATE TABLE IF NOT EXISTS `valoracion` (
  `Valoracion_Id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `idValoracion_UNIQUE` (`Valoracion_Id`),
  KEY `fk_Valoracion_por_Servicio_Personas1_idx` (`Valoracion_PersonaId`),
  KEY `fk_Valoracion_ServicioTransporte1_idx` (`Valoracion_ST_Id`),
  CONSTRAINT `fk_Valoracion_Persona` FOREIGN KEY (`Valoracion_PersonaId`) REFERENCES `personas` (`Persona_Id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `fk_Valoracion_ServicioTransporte1` FOREIGN KEY (`Valoracion_ST_Id`) REFERENCES `serviciotransporte` (`ST_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla delivery.valoracion: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `valoracion` DISABLE KEYS */;
/*!40000 ALTER TABLE `valoracion` ENABLE KEYS */;

-- Volcando estructura para tabla delivery.vehiculos
...
CREATE TABLE IF NOT EXISTS `vehiculos` (
  ...
  UNIQUE KEY `Vehiculo_Matricula_UNIQUE` (`Vehiculo_Matricula`),
  KEY `fk_Vehiculos_Personas1_idx` (`Vehiculo_PersonaId`),
  KEY `fk_Vehiculos_MedioTransporte1_idx` (`Vehiculo_MTId`),
  CONSTRAINT `fk_Vehiculos_MedioTransporte1` FOREIGN KEY (`Vehiculo_MTId`) REFERENCES `mediotransporte` (`MT_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Vehiculos_Personas1` FOREIGN KEY (`Vehiculo_PersonaId`) REFERENCES `personas` (`Persona_Id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla delivery.vehiculos: ~2 rows (aproximadamente)
...
-- Volcando estructura para disparador delivery.Pago_Suscripcion_AFTER_UPDATE
DROP TRIGGER IF EXISTS `Pago_Suscripcion_AFTER_UPDATE`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `delivery`.`Pago_Suscripcion_AFTER_UPDATE` AFTER UPDATE ON `Pago_Suscripcion` FOR EACH ROW
BEGIN
